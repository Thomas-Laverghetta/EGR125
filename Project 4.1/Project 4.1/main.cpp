/* 
 ...
 Inputs: 
	Playing Mod (P v P or P v Cp), user's name, who's first, 
	Row-Col plays.
 
 Outputs: 
	Music (pending on program circumstances), game board with move made,
	displaying name of winner, names of users. (there are more outputs, however
	there's alot, so i enter the important one's above)

 Program Description: 
	Program allows user to play TicTacToe! The program asks if you want to play 
	"Player VS Player" or "Player Vs Computer." Then ask for user name/names.
	Then it asks if you want to choose who goes first or if you want the
	computer choose randumlly. Then you Play! Through out the progrocess, the 
	computer will be playing music. When playing, the User enter the traditional
	row then col mixture using letters and numbers (Ex: A3, A = row & 3 = col). 
	At the end, the computer will play appropiate music for winner, and ask
